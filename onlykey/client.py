...
if version_info[0] == 3 and version_info[2] > 4:
...
class OnlyKey(object):
    ...
    def generate_backup_key(self):
        ...
        print('WARNING - Only run this on a trusted device, save the backup key to a secure location, and then '
              'securely delete the backup key')
        ecc_type = 161
        default_slot = 132
